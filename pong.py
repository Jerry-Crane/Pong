...
#Background
# Idk why the music you gave in the task doesn't work even after coverting it to a .wav file, so I put on another sound just to show the command
winsound.PlaySound("bicycle_bell.wav", winsound.SND_ASYNC)
